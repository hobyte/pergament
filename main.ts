...
export default class Pergament extends Plugin {
	...
	async onload() {
		...
		this.addCommand({
			...
			checkCallback: (checking: boolean) => {
				...
				if (markdownView) {
					...
					if (!checking) {
						new PergamentModal(this.app).open();
						//open canvas
					}
		...
		this.addSettingTab(new PergamentSettingTab(this.app, this));
...
class PergamentModal extends Modal {
	constructor(app: App) {
		super(app);
	}
...
class PergamentSettingTab extends PluginSettingTab {
	plugin: Pergament;
